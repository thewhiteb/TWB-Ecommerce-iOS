...
extension Constants {
    ...
    static let imageBG: Color = .init(hex: "#F5F5F5")
    static let bloodRed: Color = .init(hex: "#931935")
    static let creamColor: Color = .init(hex: "#F3EEE7")
    static let lightGray2: Color = .init(hex: "#F5F5F5")
